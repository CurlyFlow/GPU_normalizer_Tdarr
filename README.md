...
| Workload | CPU reference | GPU `1.2.2` | Speed vs CPU | Result |
| --- | ---: | ---: | ---: | --- |
| Original 5.1 | `18.3s` | `40.4s` | `0.454x` | ![GPU 120% slower](https://img.shields.io/badge/GPU-120%25%20slower-red)<br>![5.1 parity passed](https://img.shields.io/badge/5.1%20parity-passed-brightgreen) |
| Generated 2ch | `5.0s` | `40.4s` | `0.123x` | ![GPU 711% slower](https://img.shields.io/badge/GPU-711%25%20slower-red)<br>![+2ch parity passed](https://img.shields.io/badge/%2B2ch%20parity-passed-brightgreen) |
| Combined | `23.3s` | `40.5s` | `0.576x` | ![GPU 74% slower](https://img.shields.io/badge/GPU-74%25%20slower-red)<br>![5.1 parity passed](https://img.shields.io/badge/5.1%20parity-passed-brightgreen)<br>![+2ch parity passed](https://img.shields.io/badge/%2B2ch%20parity-passed-brightgreen) |

### 30s

| Workload | CPU reference | GPU `1.2.2` | Speed vs CPU | Result |
| --- | ---: | ---: | ---: | --- |
| Original 5.1 | `9.8s` | `25.7s` | `0.382x` | ![GPU 162% slower](https://img.shields.io/badge/GPU-162%25%20slower-red)<br>![5.1 parity passed](https://img.shields.io/badge/5.1%20parity-passed-brightgreen) |
| Generated 2ch | `2.6s` | `25.7s` | `0.101x` | ![GPU 893% slower](https://img.shields.io/badge/GPU-893%25%20slower-red)<br>![+2ch parity passed](https://img.shields.io/badge/%2B2ch%20parity-passed-brightgreen) |
| Combined | `12.4s` | `25.8s` | `0.482x` | ![GPU 107% slower](https://img.shields.io/badge/GPU-107%25%20slower-red)<br>![5.1 parity passed](https://img.shields.io/badge/5.1%20parity-passed-brightgreen)<br>![+2ch parity passed](https://img.shields.io/badge/%2B2ch%20parity-passed-brightgreen) |
