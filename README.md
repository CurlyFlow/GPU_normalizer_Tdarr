...
Compared with the previous releases, `1.1.7` reduces measured GPU runtime. The badges show speed change versus the previous release for the same case, calculated as `previous time / current time - 1`; green is faster, red is slower, and grey is baseline. Empty cells mean no value was published for that release and case.

| Version | 30s GPU Time | 60s GPU Time | 10min GPU Time | 30min GPU Time |
| --- | ---: | ---: | ---: | ---: |
| `1.1.7` | `16.6s`<br>![faster +23%](https://img.shields.io/badge/faster-%2B23%25-brightgreen) | `31.2s`<br>![faster +17%](https://img.shields.io/badge/faster-%2B17%25-brightgreen) | | `841.4s`<br>![faster +15%](https://img.shields.io/badge/faster-%2B15%25-brightgreen) |
| `1.1.6` | `20.5s`<br>![faster +21%](https://img.shields.io/badge/faster-%2B21%25-brightgreen) | `36.5s`<br>![faster +37%](https://img.shields.io/badge/faster-%2B37%25-brightgreen) | | `964.1s`<br>![faster +57%](https://img.shields.io/badge/faster-%2B57%25-brightgreen) |
| `1.1.5` | `24.9s` | `50.1s`<br>![slower 0.4%](https://img.shields.io/badge/slower-0.4%25-red) | | `1513.4s`<br>![slower 0.4%](https://img.shields.io/badge/slower-0.4%25-red) |
| `1.1.4` | | `49.9s`<br>![baseline 1.1.4](https://img.shields.io/badge/baseline-1.1.4-lightgrey) | | `1507.6s`<br>![baseline 1.1.4](https://img.shields.io/badge/baseline-1.1.4-lightgrey) |
