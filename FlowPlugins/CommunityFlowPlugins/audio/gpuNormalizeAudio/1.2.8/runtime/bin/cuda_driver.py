...
def load_cuda():
    ...
    try:
        cuda.cuCtxPushCurrent_v2.argtypes = [ctypes.c_void_p]
        cuda.cuCtxPopCurrent_v2.argtypes = [ctypes.POINTER(ctypes.c_void_p)]
        cuda._has_ctx_push_api = True
    except AttributeError:
        cuda._has_ctx_push_api = False
    ...
    try:
        ...
        cuda.cuStreamWaitEvent.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_uint]
...
def has_ctx_push_api(cuda):
    return bool(getattr(cuda, '_has_ctx_push_api', False))
