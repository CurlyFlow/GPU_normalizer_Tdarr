...
function resolvePairedApplyStrategy(config) {
  return {
    ...
    directMux: {
      ...
      encodedFifoOriginal: config.pairStereoFallbackApplyEncodedFifoMuxOriginal,
      ...
      originalOnly: config.pairStereoFallbackApplyDirectMuxOriginalOnly,
      osPipe: config.pairStereoFallbackApplyDirectMuxOsPipe,
