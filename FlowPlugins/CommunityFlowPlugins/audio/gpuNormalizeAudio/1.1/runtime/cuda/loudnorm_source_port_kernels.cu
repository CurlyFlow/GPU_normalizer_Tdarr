...
extern "C" __device__ void true_peak_limiter_dev(
    ...
    if (frame_type == 0) {
        ...
        if (max_v > ceiling) {
            gain_reduction1_work = ceiling / max_v;
            limiter_state_work = 2;
            for (int n = 0; n < (int)attack_length; n++) {
                for (int c = 0; c < (int)channels; c++) {
                    limiter_buf[n * (int)channels + c] *= gain_reduction1_work;
    ...
    const int skip_peak_detection = feedback_enabled && channels == 6U && limiter_state_work == 0 && limiter_maybe_above_ceiling == 0;
    if (!skip_peak_detection) do {
        if (limiter_state_work == 0) {
            ...
            if (peak_delta != -1) {
                ...
                gain_reduction1_work = ceiling / peak_value;
            ...
            for (; env_cnt_work < attack_state_work; env_cnt_work++) {
                for (int c = 0; c < (int)channels; c++) {
                    double env = gain_reduction0_work - ((double)(env_cnt_work) / (double)(attack_state_work - 1) * (gain_reduction0_work - gain_reduction1_work));
                    limiter_buf[env_index_work + c] *= env;
                    if (profile_counts) profile_counts[FB_D_COUNT_LIMITER_RW_SCALES] += 1.0;
                }
            ...
            if (peak_delta == -1) {
                ...
                if (gain_reduction < gain_reduction1_work) {
                    ...
                    for (env_cnt_work = 0; env_cnt_work < peak_delta; env_cnt_work++) {
                        for (int c = 0; c < (int)channels; c++) {
                            limiter_buf[env_index_work + c] *= gain_reduction1_work;
                            if (profile_counts) profile_counts[FB_D_COUNT_LIMITER_RW_SCALES] += 1.0;
                        }
                        env_index_work += (int)channels;
                        if (env_index_work >= (int)limiter_buf_size) env_index_work -= (int)limiter_buf_size;
            ...
            for (; env_cnt_work < (int)release_length; env_cnt_work++) {
                for (int c = 0; c < (int)channels; c++) {
                    double env = gain_reduction0_work + (((double)(env_cnt_work) / (double)(release_length - 1)) * (gain_reduction1_work - gain_reduction0_work));
                    limiter_buf[env_index_work + c] *= env;
                    if (profile_counts) profile_counts[FB_D_COUNT_LIMITER_RW_SCALES] += 1.0;
                }
                env_index_work += (int)channels;
    ...
    *gain_reduction1 = gain_reduction1_work;
    ...
    if (feedback_enabled && channels == 6U) {
        ...
        for (unsigned int n = 0; n < nb_samples; n++) {
            ...
            output[output_index + 0] = out;
            {
                ...
                double v3 = s02;
                double v4 = s03;
                double v0 = out - a1 * v1 - a2 * v2 - a3 * v3 - a4 * v4;
                double y = b0 * v0 + b1 * v1 + b2 * v2 + b3 * v3 + b4 * v4;
                frame_sum += y * y;
                s03 = v3;
                s02 = v2;
                s01 = v1;
                s00 = fabs(v0) < 2.2250738585072014e-308 ? 0.0 : v0;
            }
            ...
            output[output_index + 1] = out;
            {
                ...
                s12 = v2;
                s11 = v1;
                s10 = fabs(v0) < 2.2250738585072014e-308 ? 0.0 : v0;
            }
            ...
            output[output_index + 2] = out;
            {
                ...
                s22 = v2;
                s21 = v1;
                s20 = fabs(v0) < 2.2250738585072014e-308 ? 0.0 : v0;
            }
            ...
            output[output_index + 4] = out;
            {
                ...
                s32 = v2;
                s31 = v1;
                s30 = fabs(v0) < 2.2250738585072014e-308 ? 0.0 : v0;
            }
            ...
            output[output_index + 5] = out;
            {
                ...
                s42 = v2;
                s41 = v1;
                s40 = fabs(v0) < 2.2250738585072014e-308 ? 0.0 : v0;
            }
        ...
        for (unsigned int c = 0; c < channels; c++) {
            ...
            if (feedback_enabled) {
                ...
                if (slot >= 0) {
                    ...
                    double v0 = out - a[1] * v1 - a[2] * v2 - a[3] * v3 - a[4] * v4;
                    ...
                    out_states_work[base + 0] = fabs(v0) < 2.2250738585072014e-308 ? 0.0 : v0;
                }
            }
        }
        if (feedback_enabled) {
    ...
    if (channels <= 16U) {
        ...
        for (unsigned int n = 0; n < frames; n++) {
            ...
            for (unsigned int c = 0; c < channels; c++) {
                ...
                const double v0 = x - a[1] * v1s[c] - a[2] * v2s[c] - a[3] * v3s[c] - a[4] * v4s[c];
                const double y = b[0] * v0 + b[1] * v1s[c] + b[2] * v2s[c] + b[3] * v3s[c] + b[4] * v4s[c];
                frame_sum += y * y * ebur_slot_weight_dev(slot);
                v4s[c] = v3s[c];
                v3s[c] = v2s[c];
                v2s[c] = v1s[c];
                v1s[c] = fabs(v0) < 2.2250738585072014e-308 ? 0.0 : v0;
            }
...
extern "C" __global__ void apply_plan_f64_io_ffmpeg_feedback_limiter_stream_kernel(
    ...
    if (state_i[FB_I_INITIALIZED] == 0) {
        ...
        for (unsigned int n = 0; n < limiter_lookahead_frames; n++) {
            if (channels == 6U && n < total_frames && n >= input_base_frame && n < input_base_frame + input_frames) {
                ...
                const double v0 = input[src_base + 0] * init_gain;
                const double v1 = input[src_base + 1] * init_gain;
                const double v2 = input[src_base + 2] * init_gain;
                const double v3 = input[src_base + 3] * init_gain;
                const double v4 = input[src_base + 4] * init_gain;
                const double v5 = input[src_base + 5] * init_gain;
                ...
                for (unsigned int c = 0; c < channels; c++) {
                    double v = feedback_input_sample_dev(input, input_base_frame, input_frames, total_frames, n, c, channels, state_i, profile_counts) * init_gain;
    ...
    while (produced < output_frames && out_frame < total_frames) {
        if (use_final_flush && out_frame >= prefinal_frames) {
            if (!final_initialized) {
                ...
                for (unsigned int n = 0; n < limiter_lookahead_frames; n++) {
                    ...
                    if (channels == 6U && src_frame < total_frames && src_frame >= input_base_frame && src_frame < input_base_frame + input_frames) {
                        ...
                        const unsigned long long dst_base = (unsigned long long)n * 6ULL;
                        const double v0 = input[src_base + 0] * final_gain;
                        const double v1 = input[src_base + 1] * final_gain;
                        const double v2 = input[src_base + 2] * final_gain;
                        const double v3 = input[src_base + 3] * final_gain;
                        const double v4 = input[src_base + 4] * final_gain;
                        const double v5 = input[src_base + 5] * final_gain;
                        ...
                        for (unsigned int c = 0; c < channels; c++) {
                            double v = feedback_input_sample_dev(input, input_base_frame, input_frames, total_frames, src_frame, c, channels, state_i, profile_counts) * final_gain;
            ...
            for (unsigned int n = 0; n < frames_per_window; n++) {
                ...
                if (channels == 6U && have_src && src_frame >= input_base_frame && src_frame < input_base_frame + input_frames) {
                    ...
                    for (unsigned int c = 0; c < channels; c++) {
                        double v = have_src ? feedback_input_sample_dev(input, input_base_frame, input_frames, total_frames, src_frame, c, channels, state_i, profile_counts) * final_gain : 0.0;
                        if (v > ceiling || v < -ceiling) limiter_maybe_above_ceiling = 1;
        ...
        if (!first) {
            ...
            const double inv_nb = nb > 0 ? 1.0 / (double)nb : 0.0;
            const double gain_base = gain * offset_amp;
            const double gain_step = gain_diff * inv_nb * offset_amp;
            for (unsigned int n = 0; n < nb; n++) {
                double timed_gain = gain_base + (double)n * gain_step;
                if (channels == 6U && write_frame < total_frames && write_frame >= input_base_frame && write_frame < input_base_frame + input_frames) {
                    ...
                    const unsigned long long dst_base = (unsigned long long)write_index * 6ULL;
                    const double v0 = input[src_base + 0] * timed_gain;
                    const double v1 = input[src_base + 1] * timed_gain;
                    const double v2 = input[src_base + 2] * timed_gain;
                    const double v3 = input[src_base + 3] * timed_gain;
                    const double v4 = input[src_base + 4] * timed_gain;
                    const double v5 = input[src_base + 5] * timed_gain;
                    if (v0 > ceiling || v0 < -ceiling || v1 > ceiling || v1 < -ceiling || v2 > ceiling || v2 < -ceiling || v3 > ceiling || v3 < -ceiling || v4 > ceiling || v4 < -ceiling || v5 > ceiling || v5 < -ceiling) limiter_maybe_above_ceiling = 1;
                    limiter_buf[dst_base + 0] = v0;
                    limiter_buf[dst_base + 1] = v1;
                    limiter_buf[dst_base + 2] = v2;
                    ...
                    for (unsigned int c = 0; c < channels; c++) {
                        double v = feedback_input_sample_dev(input, input_base_frame, input_frames, total_frames, write_frame, c, channels, state_i, profile_counts) * timed_gain;
                        if (v > ceiling || v < -ceiling) limiter_maybe_above_ceiling = 1;
                        limiter_buf[((unsigned long long)write_index * channels) + c] = v;
                        if (profile_counts) profile_counts[FB_D_COUNT_LIMITER_WRITES] += 1.0;
                    }
