...
const details = () => ({
  ...
  inputs: [
    ...
    { label: "GPU Chunk MiB", name: "gpuChunkMiB", type: "string", defaultValue: "32", inputUI: { type: "text" }, tooltip: "Input/gain/output chunk size used by the GPU runtime." },
...
const plugin = async (args) => {
  ...
  const gpuChunkMiB = String(args.inputs.gpuChunkMiB || "32").trim();
  if (useGpuSourcePort) {
