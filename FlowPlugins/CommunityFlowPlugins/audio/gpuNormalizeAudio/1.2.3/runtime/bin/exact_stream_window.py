...
class ExactLimiterStreamWindow:
    def __init__(self, fh, host_in, *, frame_bytes, chunk_bytes, apply_input_chunk_bytes, prefetch_enabled=None, prefetch_extra_chunks=2):
        self.fh = fh
        ...
        self.prefetch_aligned_fastpath = self.prefetch_enabled and env_flag('LOUDNORM_GPU_PREFETCH_ALIGNED_FASTPATH')
        self.logical_trim = env_flag('LOUDNORM_GPU_EXACT_STREAM_RING')
