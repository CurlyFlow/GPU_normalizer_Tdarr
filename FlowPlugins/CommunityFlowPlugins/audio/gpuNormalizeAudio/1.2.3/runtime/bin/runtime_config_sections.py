...
def derive_exact_feature_config(args, *, exact_limiter_active, source_config):
    ...
    exact_stats_async_pipeline = exact_stats_fast_launch and not source_config.source_precompute_device_input and env_flag('LOUDNORM_GPU_STATS_ASYNC_PIPELINE')
