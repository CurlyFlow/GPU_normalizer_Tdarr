...
class PairedApplyOrchestrator:
    ...
    def start_shell(self, name, command, *, tee_paths=(), emit_stdout=True, stderr_path=None):
        handles = []
        stdout = None
        stderr = None
        output_thread = None
    ...
    def start_direct_mux(self):
        ...
        return start_ns, self.start_shell('direct_mux', direct_mux['command'], stderr_path=direct_mux['errPath'])
