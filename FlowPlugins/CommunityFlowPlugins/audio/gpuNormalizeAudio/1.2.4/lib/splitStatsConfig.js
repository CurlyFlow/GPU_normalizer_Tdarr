...
function createSplitStatsConfig({
  ...
  const pairStereoFallbackSplitStats = (envFlag("LOUDNORM_GPU_PAIR_FALLBACK_STATS") || pairStereoFallbackSplitStatsBufferedDecode) && args.platform !== "win32";
  ...
  const pairStereoFallbackSplitStatsFuseMeasure = pairStereoFallbackSplitStats && (envFlag("LOUDNORM_GPU_PAIR_FALLBACK_STATS_FUSE_MEASURE") || pairStereoFallbackSplitStatsBufferedDecode);
