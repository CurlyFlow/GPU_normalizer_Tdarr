...
function createPairedApplyConfig({ args, useGpuSourcePort, useStreamingSourcePort }) {
  ...
  const pairStereoFallbackApplyFirstReady = pairStereoFallbackApply && !pairStereoFallbackApplySingleRuntime && envFlag("LOUDNORM_GPU_PAIR_FALLBACK_APPLY_FIRST_READY");
