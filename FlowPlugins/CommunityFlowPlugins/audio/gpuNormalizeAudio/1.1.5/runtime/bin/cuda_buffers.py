...
class RuntimeBuffers:
    ...
    def free_order(self):
        return [
            ...
            self.d_feedback_hist, self.d_feedback_state_d, self.d_feedback_state_i,
...
def allocate_runtime_buffers(cuda, args, windows, chunk_bytes, apply_input_chunk_bytes, output_chunk_bytes, limiter_alloc_frames, exact_limiter_active):
