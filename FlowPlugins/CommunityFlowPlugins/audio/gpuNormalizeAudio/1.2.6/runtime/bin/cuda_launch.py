...
def launch_kernel(cuda, profile_label, kernel_fn, launch_args, *, grid_x=1, block_x=1, grid_y=1, grid_z=1, block_y=1, block_z=1, shared_mem=0, stream=None, check_label=None):
