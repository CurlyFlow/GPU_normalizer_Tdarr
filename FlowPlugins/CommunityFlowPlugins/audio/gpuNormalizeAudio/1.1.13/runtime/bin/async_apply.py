...
from cuda_driver import alloc_pinned_host_buffer, chk, cuda_event_create, cuda_event_destroy, cuda_event_pair_seconds
...
def setup_async_apply(cuda, args, buffers, *, chunk_bytes, output_chunk_bytes):
    ...
    if args.output_format != 'f32le':
        ...
        return resources
    if not getattr(cuda, '_has_async_apply_api', False):
