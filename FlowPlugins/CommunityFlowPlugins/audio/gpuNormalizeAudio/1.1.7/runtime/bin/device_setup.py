...
from feedback_apply import copy_feedback_state_i_to_device, new_feedback_state_i
...
def initialize_runtime_buffers(cuda, args, buffers, *, cfg, state_bytes, b_coeffs, a_coeffs):
    ...
    if cfg.exact_limiter_active:
        ...
        chk(cuda.cuMemsetD32_v2(buffers.d_feedback_state_i, 0, 32), 'cuMemsetD32(feedback_state_i)')
        chk(cuda.cuMemsetD32_v2(buffers.d_feedback_state_d, 0, 128 * 2), 'cuMemsetD32(feedback_state_d)')
        ...
        if cfg.exact_profile_counts or cfg.exact_prefill_output:
            feedback_state_i_init = new_feedback_state_i(profile_counts=cfg.exact_profile_counts, prefilled_output=cfg.exact_prefill_output)
...
class KernelArgBindings:
    ...
    def as_tuple(self):
        return (
            ...
            self.metrics_arg, self.channels_arg, self.frame_window_arg, self.windows_arg,
