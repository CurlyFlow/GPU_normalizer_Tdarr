...
extern "C" __device__ void true_peak_limiter_dev(
    ...
    *gain_reduction1 = gain_reduction1_work;
    ...
    if (!LOUDNORM_EXACT_GENERIC_LIMITER && feedback_enabled && channels == 6U && limiter_maybe_above_ceiling < -1 && limiter_state_work == 0) {
        ...
        add_feedback_output_dev(output, output_frame_offset, nb_samples, channels, frames_per_window, b, a, 0, out_states, out_short_ring, out_short_sum, out_short_index, out_short_count, out_window_sum, out_window_count);
