...
| --- | ---: | ---: | ---: | --- |
| Original 5.1 | `1072.6s` | `609.3s` | `1.760x` | Pass, 5.1 exact parity |
| Generated 2ch | `297.2s` | `621.7s` | `0.478x` | Pass, +2ch exact parity |
| Combined | `1369.8s` | `1237.2s` | `1.107x` | Pass, both streams exact |

### 30min

| Workload | CPU reference | GPU 1.1.11 | Speed vs CPU | Result |
| --- | ---: | ---: | ---: | --- |
| Original 5.1 | `529.0s` | `310.6s` | `1.703x` | Pass, 5.1 exact parity |
| Generated 2ch | `149.1s` | `322.2s` | `0.463x` | Pass, +2ch exact parity |
| Combined | `678.0s` | `634.9s` | `1.068x` | Pass, both streams exact |

### 10min

| Workload | CPU reference | GPU 1.1.11 | Speed vs CPU | Result |
| --- | ---: | ---: | ---: | --- |
| Original 5.1 | `175.2s` | `105.2s` | `1.665x` | Pass, 5.1 exact parity |
| Generated 2ch | `48.4s` | `111.2s` | `0.435x` | Pass, +2ch exact parity |
| Combined | `223.6s` | `217.2s` | `1.030x` | Pass, both streams exact |

### 60s

| Workload | CPU reference | GPU 1.1.11 | Speed vs CPU | Result |
| --- | ---: | ---: | ---: | --- |
| Original 5.1 | `18.2s` | `13.7s` | `1.326x` | Pass, 5.1 exact parity |
| Generated 2ch | `4.8s` | `17.0s` | `0.285x` | Pass, +2ch exact parity |
| Combined | `23.0s` | `30.8s` | `0.746x` | Pass, both streams exact |

### 30s

| Workload | CPU reference | GPU 1.1.11 | Speed vs CPU | Result |
| --- | ---: | ---: | ---: | --- |
| Original 5.1 | `9.4s` | `8.6s` | `1.092x` | Pass, 5.1 exact parity |
| Generated 2ch | `2.6s` | `12.4s` | `0.208x` | Pass, +2ch exact parity |
| Combined | `11.9s` | `21.1s` | `0.567x` | Pass, both streams exact |
