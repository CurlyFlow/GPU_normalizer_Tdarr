...
def build_source_exact_from_channel_sums_args(channel_sums_arg, source_exact_sums_arg, windows_arg, channels_arg):
    return (ctypes.c_void_p * 4)(ptr_arg(channel_sums_arg), ptr_arg(source_exact_sums_arg), ptr_arg(windows_arg), ptr_arg(channels_arg))
